...
const VIDEOS: VideoItem[] = [
  { id: "10", title: "Spice Health 1", youtubeId: "cJejgC9xP2s" },
  { id: "3", title: "Naina Avtr Episode 3", youtubeId: "PR3oDLy2Qnc" },
  { id: "16", title: "Dino's", youtubeId: "kdtAJHf9Puo" },
  { id: "7", title: "Naina Avtr Episode 7", youtubeId: "Myz4CIC48BU" },
  { id: "13", title: "Old Harbour Tea 2", youtubeId: "YPQuJ4Wo7IE" },
  { id: "1", title: "Naina Avtr Episode 1", youtubeId: "945XSuix4Fo" },
  { id: "18", title: "Atta Girl", youtubeId: "6Z_w3nBplC4" },
  { id: "5", title: "Naina Avtr Episode 5", youtubeId: "lHAl_LuTaLs" },
  { id: "12", title: "Old Harbour Tea 1", youtubeId: "4zLOElCtkl4" },
  { id: "9", title: "Naina Avtr Episode End", youtubeId: "ZWIdZzCzAIg" },
  { id: "17", title: "August Cafe", youtubeId: "PrSgSzsiEco" },
  { id: "2", title: "Naina Avtr Episode 2", youtubeId: "B-95suTQPp8" },
  { id: "15", title: "Food Strong", youtubeId: "_LYY0bp4XBE" },
  { id: "8", title: "Naina Avtr Episode 8", youtubeId: "rH8L0byc-tM" },
  { id: "11", title: "Spice Health 2", youtubeId: "rpKU3TYW2eI" },
  { id: "4", title: "Naina Avtr Episode 4", youtubeId: "BoYE0bKJHsM" },
  { id: "14", title: "Old Harbour Tea 3", youtubeId: "zN6388dFxkY" },
  { id: "6", title: "Naina Avtr Episode 6", youtubeId: "enDeNjYz2g0" },
];

const Thumbnail = ({ video }: { video: VideoItem }) => {
  return (
    <Image
...
export default function PlaylistVideosScroller() {
  const [activeItem, setActiveItem] = useState<{ youtubeId?: string } | null>(null);
  ...
  const scrollerItems = [...VIDEOS, ...VIDEOS]; // Duplicated for seamless loop
  ...
  return (
    <div className="relative w-full py-12 bg-neutral-950/50 rounded-3xl border border-white/5 overflow-hidden mb-16">
      <div className="px-8 md:px-12 mb-8">
        <h3 className="text-3xl font-bold text-white mb-2">Motion Graphics</h3>
      ...
      <div ref={outerRef} className="relative flex w-full overflow-hidden pl-4 md:pl-12">
        ...
        >
          {scrollerItems.map((video, idx) => (
            <div
              key={`${video.id}-${idx}`}
              onClick={() => {
                // Prevent click if user was just dragging
                if (!isDragging) {
                  setActiveItem({ youtubeId: video.youtubeId });
                }
              }}
